...
st.write("##### **OddsMeter** :video_game:: know the winning odds of your last games and if you were :orange[Afraid to Win] :collision: or you :green[Defied the Odds] :heart_on_fire:")
